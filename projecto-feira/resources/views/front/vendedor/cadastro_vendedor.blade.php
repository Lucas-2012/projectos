...
<section class="site-section bg-light" id="contact-section">
      <div class="container" style="margin-top:100px;">
        ...
        <div class="col-12 text-center" style="background-color: #f3ae34;">
            <h2 class="text-black h1 site-section-heading" style="padding-top: 10px;">Cadastrando-se como VENDEDOR</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 mb-5">
          <form action="{{route('guarda.vendedor')}}" method="POST" class="p-5 bg-white" enctype="multipart/form-data">
            @csrf 
              ...
              <div class="row form-group">
                ...
                <div class="col-md-6  mb-3 mb-md-0">
                  ...
                  <input type="text" id="subject" name="telefone" class="form-control" placeholder="seu número de telefone" required>
                </div>
              </div>
              ...
              <label class="text-black"><b>Selecione as categorias de produtos que possues</b></label>
              <div class="row form-group">

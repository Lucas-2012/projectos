<div class="col-md-6 col-lg-4">
    <a href="{{route('inscrever.mercado', [$mercado->id])}}"  alt="{{$mercado->designacao}}" class="media-1">
        ...
        <div class="media-1-content">
            ...
            <span class="category">
                <button href="{{route('inscrever.mercado', [$mercado->id])}}" class="btn btn-primary btn-md" style="background-color: #f3ae34; border: red;">Entrar</button>
            </span><br>
        </div>
    </a>
</div>

          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header" style="background-color: #6C757D; color: #ffffff">
                <h3 class="card-title" >Dados do Feirante</h3>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
                ...
                <form role="form" action="{{route('feirante.update', $feirante->id)}}" method="POST" enctype="multipart/form-data">
                @csrf 
                @method('PUT') 
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$feirante->user->name}}" placeholder="nome" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>E-mail</label>
                        <input type="email" class="form-control" name="email" value="{{$feirante->user->email}}" placeholder="email" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="provincia">
                          ...
                          @foreach($provincias as $provincia)
                            @if($provincia->id === $feirante->provincia_id)
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="telefone" value="{{$feirante->telefone}}" placeholder="921 227 523" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">

...
@section('title','Cadastrar Feirante')
@section('content')
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <form role="form" action="{{route('feirante.guardar')}}" method="POST" enctype="multipart/form-data">
                @csrf  
                <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                  ...
                  <div class="row">
                     <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="telefone" placeholder="921 227 523" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                  ...
                  <label>Selecione as categorias de produtos que possuis<!--b style="color: red;">*</b--></label>
                  <div class="row">
